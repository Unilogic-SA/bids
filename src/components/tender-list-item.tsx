...
export function TenderListItem({
  ...
  return (
    <Link
      ...
      className="group relative flex min-w-0 scroll-mt-20 flex-col gap-2.5 rounded-lg border bg-card px-3.5 py-2.5 text-card-foreground transition-colors hover:bg-accent/40 focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50"
      href={detailUrl}
      id={resultId}
      onClick={() =>
